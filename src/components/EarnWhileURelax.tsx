    ...
    <section className="earnwhileyourelax relative">
      <div className="z-2 relative">
        <section className="bg-transparent px-5 py-[50px] text-white font-medium mt-0 sm:mt-0">
          <h2 className="md:text-[48px] md:leading-12 font-extrabold text-center font-sans  mb-2.5 decoration-skip-ink-none text-[24px] leading-[30px]">
            <span className="text-[#f7be15] text-[clamp(1.375rem,0.7475rem+2.5743vw,3rem)]!">
              Earn
            </span>{" "}
            while you relax
          </h2>
          <p className="text-[12px] leading-[13.45px] font-bold text-center font-s[Poppins] mb-0 sm:text-[18px] sm:leading-7 sm:mb-[30px]">
          ...
          <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-5 text-center lg:text-left lg:gap-[30px]">
            ...
            <div className="performance-card">
              ...
              <img
                ...
                className="w-full rounded-2.5 mb-2.5"
              />
              <p className="text-[0.9em] text-[#ccc] mt-2.5 text-center">
            ...
            <div className="p-2 rounded-[23.521px] max-w-md bg-white shadow-[0_0_15.858px_rgba(0,0,0,0.2)] md:w-full">
              ...
              >
                ...
                <div>
                  <label
                    className="block mb-2.5 text-base text-black font-bold"
                    htmlFor="followers"
                  >
                  ...
                  <input
                    ...
                    id="followers"
                    max={'1000000'}
                    className="w-[96%] px-2.5 py-2.5 rounded-[15px] text-center mb-2.5 border-[2.18px] border-gray-400 text-[17.43px] font-bold leading-[26.15px] bg-white"
                    value={followers.toLocaleString()}
                    onChange={(e) =>
                      handleChange(Number(e.target.value.replace(/,/g, "")))
                    }
                  />
                  <input
                    id="followers-range"
                    type="range"
                    className="slider accent-yellow-400 followers-slider mt-2 w-full"
                    min="1000"
                    max="1000000"
                    step="1000"
                    value={followers}
